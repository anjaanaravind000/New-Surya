...
// Shared Credit Tab – used by AdminSecondaryRetailOperations, AdminPrimaryRetailOperations, and AdminDashboard
...
interface AdminCreditTabProps {
  branches: Branch[];
  accentColor?: string; // e.g. 'text-blue-700' for SECONDARY_OUTLET, 'text-amber-600' for PRIMARY_OUTLET
}
