  ...
  return <div className="space-y-5">
    <section className="border border-slate-800 bg-[#151a1f] p-5 text-white shadow-lg">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div><div className="flex items-center gap-2 text-xs font-bold text-[#e6bc72]"><BarChart3 className="size-4" />EXECUTIVE AND ADMINISTRATION INTELLIGENCE</div><h2 className="mt-2 text-2xl font-extrabold">Business visualization studio</h2><p className="mt-2 max-w-3xl text-sm leading-6 text-slate-300">Live visual summaries across branches, billing channels, production, inventory, customers and fulfilment.</p></div>
