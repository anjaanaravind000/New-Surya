...
// Actual retail details matching the physical receipt
const RETAIL = {
  name: 'New Surya',
  address: '#109/1C, Wholesale main Road, Berigai,\nSoolagiri TK, Krishnagiri DT,\nTamilnadu 635105',
  gst: '33AAZFV1266C1ZZ',
      ...
      <div className="relative bg-white rounded-2xl w-[92vw] max-w-sm max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div id="receipt-print-area" className="px-5 py-4 font-mono text-[12px] text-gray-900 select-none leading-snug">
          ...
          <div className="text-center mb-2">
            ...
            <p className="text-sm font-black">{RETAIL.name}</p>
            <p className="text-[10px] text-gray-600 whitespace-pre-line leading-tight mt-0.5">{RETAIL.address}</p>
            <p className="text-[10px] text-gray-600 mt-0.5">GST No: {RETAIL.gst}</p>
            <p className="text-[10px] text-gray-600">FSSAI No: {RETAIL.fssai}</p>
          </div>
