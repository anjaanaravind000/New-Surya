// src/branch?suite=secondary-branch-operationsItems.ts
// Auto-generated from NEW_SURYA_FINAL_PRICE_LIST.xlsx
// Used by SECONDARY_OUTLET branch for billing and admin item management.

export interface SecondaryOutletItem {
  barcode: number;
  name: string;
  price: number;
  uom: 'Nos' | 'Kgs';
  category: SecondaryOutletCategory;
}

export type SecondaryOutletCategory =
  | 'CHIPS'
  | 'MURUK'
  | 'MIXTURE'
  | 'PAKODA'
...
export const SECONDARY_OUTLET_CATEGORIES: SecondaryOutletCategory[] = [
  'CHIPS',
  'MURUK',
  'MIXTURE',
  'PAKODA',
...
export const SECONDARY_OUTLET_ITEMS: SecondaryOutletItem[] = [
  // ── CHIPS ─────────────────────────────────────────────────────────────────
  ...
  // ── CHOCOLATE ─────────────────────────────────────────────────────────────
  { barcode: 2184, name: 'New Surya chocolate',                    price: 1500, uom: 'Kgs', category: 'CHOCOLATE' },
  { barcode: 2185, name: 'New Surya lollipop',                     price: 15,   uom: 'Nos', category: 'CHOCOLATE' },
