export interface WholesaleDiscountRule {
...
export interface WholesaleImportedCustomerPrice {
  itemName: string;
  unitPrice: number;
}

export interface WholesaleImportedCustomer {
  shopName: string;
  whatsappNumber: string;
  items: WholesaleImportedCustomerPrice[];
  /** Optional discount rules for this shop */
  discounts?: WholesaleDiscountRule[];
}

export const WHOLESALE_CUSTOMER_PRICE_LIST: WholesaleImportedCustomer[] = [
  {
  ...
  {
    shopName: 'VL Retail Private Ltd',
  ...
  {
    shopName: 'Rotary Club Of Wholesale',
