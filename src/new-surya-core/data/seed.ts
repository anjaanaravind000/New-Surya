...
// Single-branch launch configuration: only the central kitchen (production/warehouse)
// and one retail branch are seeded. The admin can create additional branches later
// from the Admin dashboard once the business is ready to expand.
...
export const roles: Role[] = [
  ...
  { id:'branch-incharge', name:'Branch Incharge', description:'Runs one outlet: people, counters, orders, stock, approvals, cash and closure', dashboards:['branch-incharge'] as DashboardId[], permissions:{} as any, branchIds:['marathahalli'] },
  { id:'branch-cashier', name:'Branch Cashier', description:'Counter open, billing, online orders and daily closure', dashboards:['branch'] as DashboardId[], permissions:{} as any, branchIds:['marathahalli'] },
