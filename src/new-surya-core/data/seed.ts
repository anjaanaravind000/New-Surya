...
export const roles: Role[] = [
  ...
  { id:'branch-incharge', name:'Branch Incharge', description:'Runs one outlet: people, counters, orders, stock, approvals, cash and closure', dashboards:['branch-incharge'], permissions:{} as any, branchIds:['marathahalli'] },
  { id:'branch-cashier', name:'Branch Cashier', description:'Counter open, billing, online orders and daily closure', dashboards:['branch'], permissions:{} as any, branchIds:['marathahalli'] },
