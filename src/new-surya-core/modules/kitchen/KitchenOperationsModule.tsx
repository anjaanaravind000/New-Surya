...
import { ORDER_STATUS_LABELS, RETAIL_CONFIG } from '@/constants/config';
...
<body><div class="c" style="font-size:13px;font-weight:700">${RETAIL_CONFIG.name}</div>
...
export default function KitchenOperationsModule() {
