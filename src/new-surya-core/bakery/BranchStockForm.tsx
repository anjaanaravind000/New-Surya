...
//   • Works for all 3 receivers: SECONDARY_OUTLET, PRIMARY_OUTLET, Wholesale
...
function toItemId(branch: Branch, barcode: number): string {
  return `${branch === "SECONDARY_OUTLET" ? "secondary_outlet" : "primary_outlet"}-${barcode}`;
}
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden">
      ...
      <div className="min-h-0 flex-1 space-y-3 overflow-auto px-3 pb-2">
        {/* SECONDARY_OUTLET pcs info banner */}
        {branch === "SECONDARY_OUTLET" && (
          <div className="flex items-start gap-2 px-3 py-2.5 rounded-xl bg-blue-50 border border-blue-200">
            ...
            <p className="text-[11px] font-body text-blue-800 leading-relaxed">
              <span className="font-bold">Selected outlet items sold in pieces</span> — enter
        ...
        <button
          ...
          className={cn(
            ...
            success
              ...
              : "surya-gradient text-primary-foreground",
          )}
        >
          {submitting ? (
