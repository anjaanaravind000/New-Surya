...
export const roleExtensionTabs = {
  admin: ['Visualization Studio', 'Expenses', 'Complaints', 'Quotations', 'Purchase Returns', 'Supplier Payments', 'Bank Deposits', 'Current Cash', 'Salesperson Management', 'Cashier Controls'] as const,
  ...
  kitchen: ['Material Orders', 'Material Inventory', 'Suppliers', 'Purchase Invoices', 'Materials Analytics', 'Custom Plan', 'Materials Closure', 'Recipe Management', 'Production Queue', 'Production History', 'Packing Queue', 'Cake Orders', 'Corrections', 'Transfer In', 'Packing Billing', 'Leftover Items', 'Dispatched History', 'Packing Closure', 'Kitchen Waste Log'] as const,
